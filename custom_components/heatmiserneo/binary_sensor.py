...
BINARY_SENSORS: tuple[HeatmiserNeoBinarySensorEntityDescription, ...] = (
    ...
    HeatmiserNeoBinarySensorEntityDescription(
        ...
        setup_filter_fn=lambda device: device.device_type == 5,
    ),
    HeatmiserNeoBinarySensorEntityDescription(
    ...
    HeatmiserNeoBinarySensorEntityDescription(
        ...
        setup_filter_fn=lambda device: device.battery_powered,
    ),
    HeatmiserNeoBinarySensorEntityDescription(
        ...
        setup_filter_fn=lambda device: (
            device.device_type in [1, 2, 6, 7, 12, 13] and device.time_clock_mode
        ),
    ),
    HeatmiserNeoBinarySensorEntityDescription(
